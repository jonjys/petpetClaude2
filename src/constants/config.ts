...
export const FEATURE_HUB_ITEMS = [
  ...
  { id: 'petrobotlab', emoji: '🤖', label: 'Robotlabbet', desc: 'Bygg robotar och tjäna KC och XP' },
  ...
  { id: 'petcherrytree', emoji: '🌸', label: 'Körsbärsträdet', desc: 'Bevaka blommandet och tjäna bond och mynt varje säsong' },
  { id: 'petlighthousekeeper', emoji: '🗼', label: 'Fyrvaktaren', desc: 'Håll fyren tänd och guida skepp för KC och XP' },
  { id: 'petcauldron', emoji: '🫕', label: 'Trollkitteln', desc: 'Laga trolldrycker och tjäna KC och bond' },
  { id: 'petpuppetshow', emoji: '🎪', label: 'Dockteater', desc: 'Spela upp dockteaterpjäser och samla mynt och bond' },
  { id: 'petcrystalcave', emoji: '💎', label: 'Kristallgrottan', desc: 'Gräv kristaller och sälj på marknaden för XP och mynt' },
  { id: 'petfoxden', emoji: '🦊', label: 'Rävstugan', desc: 'Vårda räven och lär den tricks för bond och KC' },
  { id: 'petpottery', emoji: '🏺', label: 'Krukmakaren', desc: 'Dreja keramik och sälj på marknaden för mynt och XP' },
  { id: 'petnightsky', emoji: '🌠', label: 'Natthimlen', desc: 'Observera stjärnfall och meteorregn för KC och bond' },
  { id: 'petcandyshop', emoji: '🍬', label: 'Godisbutiken', desc: 'Tillverka och sälj godis för mynt och bond' },
  { id: 'petcoastalcabin', emoji: '🏕️', label: 'Kustkojan', desc: 'Bo vid havslinjen och samla KC och bond' },
  { id: 'petfirestation', emoji: '🚒', label: 'Brandstationen', desc: 'Svara på larm och tjäna mynt och XP' },
  { id: 'petdruidgrove', emoji: '🌳', label: 'Druidlunden', desc: 'Genomför naturriter och samla KC och bond' },
  { id: 'pettundra', emoji: '🌨️', label: 'Tundran', desc: 'Överlev i den kalla tundran och samla XP och KC' },
  { id: 'petmechlab', emoji: '⚙️', label: 'Mekanikerlabbet', desc: 'Bygg och reparera maskiner för mynt och XP' },
  { id: 'petstonecraft', emoji: '🪨', label: 'Stensmeden', desc: 'Hugga och forma sten till konst för bond och mynt' },
  { id: 'petviking', emoji: '🪓', label: 'Vikingalägret', desc: 'Res med vikingarna och samla XP och KC' },
  { id: 'petsea', emoji: '🌊', label: 'Havsfärden', desc: 'Segla på havet och fånga skatter för bond och mynt' },
  { id: 'petbonsai', emoji: '🎋', label: 'Bonsaiträdgården', desc: 'Odla och forma bonsaträd för bond och KC' },
  { id: 'petvolcano4', emoji: '🌋', label: 'Vulkansmedjan', desc: 'Smid vapen i vulkanens glöd för KC och XP' },
  { id: 'peticefishing', emoji: '🧊', label: 'Isfisket', desc: 'Fiska under isen och samla mynt och bond' },
  { id: 'petrocketlab', emoji: '🚀', label: 'Raketlabbet', desc: 'Bygg raketer och forska för KC och XP' },
  { id: 'petmushroom3', emoji: '🍄', label: 'Svampskogen', desc: 'Plocka sällsynta svampar i skogen för bond och mynt' },
  { id: 'petgladiator', emoji: '🗡️', label: 'Gladiatorarenan', desc: 'Kämpa i arenan och samla XP och KC' },
  { id: 'petsailship', emoji: '⛵', label: 'Segelbåten', desc: 'Segla runt världen och samla mynt och bond' },
  { id: 'petmonastery', emoji: '🏯', label: 'Klostret', desc: 'Meditera och kopiera skrifter för bond och KC' },
  { id: 'petgoldmine', emoji: '⛏️', label: 'Guldgruvan', desc: 'Gräv guld i gruvan och samla mynt och XP' },
  { id: 'petmagicwell', emoji: '🪄', label: 'Trollkällan', desc: 'Ösa magisk kraft ur källan för KC och bond' },
  ...
  { id: 'petmarinebase', emoji: '🌊', label: 'Marinbasen', desc: 'Dyk djupt och samla marina skatter för mynt och XP' },
  { id: 'petcrystalpalace', emoji: '💎', label: 'Kristallpalatset', desc: 'Bygg ett glänsande palats av kristaller för bond och KC' },
  { id: 'petvolcanoforge2', emoji: '⚒️', label: 'Lavafältet', desc: 'Smid unika artefakter i vulkansk lava för mynt och XP' },
  ...
  { id: 'petflowerfield', emoji: '🌺', label: 'Blomsterängen', desc: 'Plocka blommor och skapa buketter för bond och mynt' },
  { id: 'petmidnighttrain', emoji: '🚂', label: 'Midnattståget', desc: 'Res med tåget och samla XP och KC vid varje stopp' },
  { id: 'petcoralcave', emoji: '🐚', label: 'Korallgrottan', desc: 'Dykarexpedition i korallgrottor för bond och mynt' },
  ...
  { id: 'petmoonresearch', emoji: '🌙', label: 'Månforskning', desc: 'Forska på månen och skörda månsten för KC och XP' },
  { id: 'petanchientruins', emoji: '🏛️', label: 'Antika Ruinerna', desc: 'Utgrävning av urgamla ruiner för bond och KC' },
  { id: 'pettreehouse', emoji: '🌲', label: 'Trädkojans Vila', desc: 'Bygg och renovera din trädkoja för bond och KC' },
  { id: 'petmagicmarket', emoji: '🧿', label: 'Den Magiska Marknaden', desc: 'Handla magiska föremål och tjäna mynt och XP' },
  { id: 'petcosmicstation', emoji: '🛸', label: 'Kosmisk Station', desc: 'Bemanna rymdstationen och samla kosmisk energi för KC' },
  ...
  { id: 'petsurvivorcamp', emoji: '🦁', label: 'Survival Camp', desc: 'Överlev i djungeln och samla exotiska frukter för XP' },
  ...
  { id: 'petglasshouse', emoji: '🌿', label: 'Växthuset', desc: 'Odla exotiska växter i ditt växthus och sälj för mynt' },
  { id: 'petmedialab', emoji: '🎬', label: 'Medialabbet', desc: 'Skapa viral content och tjäna XP och KC per visning' },
  { id: 'petrobotfactory', emoji: '🤖', label: 'Robotfabriken', desc: 'Bygg och programmera robotar för KC och XP' },
  { id: 'petclockshop', emoji: '🕰️', label: 'Urmakarens Atelier', desc: 'Bygg och reparera klockor för tid-bonusar och mynt' },
  { id: 'petmathacademy', emoji: '📐', label: 'Matteakademin', desc: 'Skryt dig upp i matteranking och lås upp bonus-formler' },
  { id: 'petcalcroom', emoji: '🧮', label: 'Beräkningsrummet', desc: 'Samla ekvationer och lös dem för KC och XP' },
  { id: 'petnaturpark', emoji: '🦌', label: 'Naturparken', desc: 'Sköt om djur i naturparken och skörda KC' },
  { id: 'petcartographer', emoji: '🗺️', label: 'Kartriket', desc: 'Rita kartor och utforska okänt territorium för XP' },
  { id: 'petlightsaber', emoji: '⚔️', label: 'Duellklubben', desc: 'Delta i dueller och lös matematik för segerserie' },
  { id: 'petsavannah', emoji: '🦁', label: 'Savannen', desc: 'Vakta djur på savannen och lås upp sällsynta arter' },
  { id: 'petaquacenter', emoji: '🐬', label: 'Akvacenter', desc: 'Träna delfiner och tjäna XP för varje trick' },
  { id: 'petarithlab', emoji: '🧮', label: 'Räknelabbet', desc: 'Lös huvudräkning och samla matematikprestiger' },
  { id: 'petchessclub', emoji: '♟️', label: 'Schackklubben', desc: 'Lös schackproblem och tjäna XP och mynt' },
  { id: 'petchemlab', emoji: '🧪', label: 'Kemlabbet', desc: 'Blanda ämnen och lär dig kemi för KC och XP' },
  { id: 'petarcheryguild', emoji: '🏹', label: 'Bågskyttegillet', desc: 'Sikta rätt och tjäna XP och mynt per prick' },
  { id: 'petmuseum', emoji: '🏛️', label: 'Museet', desc: 'Kurera utställningar och locka besökare för KC och XP' },
  { id: 'pettavern', emoji: '🍺', label: 'Krogen', desc: 'Servera gäster och brygga recept för dagliga mynt' },
  { id: 'petspaceship', emoji: '🚀', label: 'Rymdskeppet', desc: 'Flyg till nya planeter och samla rymd-KC' },
  { id: 'petlibrary', emoji: '📚', label: 'Biblioteket', desc: 'Läs böcker och lös quiz för XP och mynt' },
  { id: 'petfirestation', emoji: '🚒', label: 'Brandstationen', desc: 'Rädda liv och tjäna KC vid brandstationen' },
  { id: 'petgardenclub', emoji: '🌸', label: 'Trädgårdsklubben', desc: 'Odla blommor och sälj dem för dagliga mynt' },
  { id: 'petdetective', emoji: '🔍', label: 'Detektivbyrån', desc: 'Lös mysterier och samla bevis för KC och XP' },
  { id: 'petpostoffice', emoji: '📮', label: 'Postkontoret', desc: 'Sortera post och leverera paket för dagliga mynt' },
  { id: 'petvolcano', emoji: '🌋', label: 'Vulkanön', desc: 'Utforska vulkanen och samla sällsynta mineraler' },
  { id: 'petsubmarine', emoji: '🤿', label: 'Ubåten', desc: 'Dyk djupt och utforska havsbotten för XP och KC' },
  { id: 'peticecream', emoji: '🍦', label: 'Glassbutiken', desc: 'Sälj glass och blanda smaker för dagliga mynt' },
  { id: 'petarcade', emoji: '🕹️', label: 'Arkaden', desc: 'Spela arkadspel och samla tokens för KC och XP' },
  { id: 'petpowerplant', emoji: '⚡', label: 'Kraftverket', desc: 'Drifta kraftverket och sälj energi för mynt och KC' },
  { id: 'petmathlab', emoji: '🔢', label: 'Mattelabbet', desc: 'Lös matematikproblem och tjäna XP och KC per korrekt svar' },
  { id: 'petlanguageschool', emoji: '🗣️', label: 'Språkskolan', desc: 'Lär dig nya ord och fraser och tjäna bond och mynt' },
  { id: 'petalgebracenter', emoji: '🔣', label: 'Algebracentret', desc: 'Lös ekvationer och tjäna XP och KC per korrekt svar' },
  { id: 'petgrammarhouse', emoji: '📚', label: 'Grammatikhuset', desc: 'Öva grammatik och lås upp språkliga prestiger' },
  { id: 'petobservatory', emoji: '🔭', label: 'Observatoriet', desc: 'Studera planeter och stjärnor för KC och XP' },
  { id: 'petsciencelab', emoji: '🔬', label: 'NO-labbet', desc: 'Experimentera med fysik och kemi för KC och XP' },
  { id: 'petmulticlub', emoji: '✖️', label: 'Tabellklubben', desc: 'Träna multiplikationstabellerna och tjäna dagliga mynt' },
  { id: 'petartgallery', emoji: '🎨', label: 'Konstgalleriet', desc: 'Ställ ut konst och attrahera besökare för bond och KC' },

...
export const FEATURE_HUB_ITEMS = [
  ...
  { id: 'petspacestation', emoji: '🛸', label: 'Rymdstationen', desc: 'Bemanna rymdstationen och samla kosmisk energi för KC' },
  ...
  { id: 'petrobotics', emoji: '🤖', label: 'Robotikverkstan', desc: 'Bygg och programmera robotar för KC och XP' },
